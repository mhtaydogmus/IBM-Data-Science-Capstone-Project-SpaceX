...
def update_scatterchart(site_dropdown, payload_slider):
    ...
    if site_dropdown == 'ALL':
        ...
        fig = px.scatter(filtered_df[filtered_df['Launch Site'] == site_dropdown],
                         x = 'Payload Mass (kg)',
                         y = 'class',
                         color = 'Booster Version Category',
                         title = f"Success count for site {site_dropdown}")
        return fig
